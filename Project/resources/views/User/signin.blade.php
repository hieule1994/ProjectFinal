...
<div class="center-content-re col-md-8">
    <div class="center_content ">
        ...
        <div class="group-control mrbt_10">
        	<label>Địa chỉ: </label>
        	<input type='text' name="address" class="form-control" placeholder="Quận 9, tp.Hồ Chí Minh"/>
        </div>
        <div class="group-control mrbt_10">
        	<label>Số điện thoại: </label>
        	<input type='number' name="numberphone" class="form-control" placeholder="0905123123" />
        </div>
        <div class="group-control mrbt_10">
